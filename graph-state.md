...
| D5. DB 구조 정리 | ✅ | migrations/0010(번역 유니크 · 목록 인덱스 · 문의 인덱스 · 옛 담당자 FK 제거) · 로컬 DB 재생성 | 빈 DB 에서 schema.sql + 0001~0010 · 표 18(Directus 잔여 0) · 내용 복구(글 40 · 번역 41 · 페이지 17 · 메뉴 31 · 파일 11) · 중복 번역 insert 거부됨 · verify 331/0/1 · web 8종 통과 | 로컬과 운영 구조가 같아졌다. 안 쓰는 칸(posts.program_* · en_ready · canonical · inquiries.assignee)은 남겨 뒀다 — 지우는 것은 사용자 결정 |
