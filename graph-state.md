...
| E7. 회사·사업·서비스 페이지 | 🔶 합침·검증 대기 | 15 장 스키마(intro-pages.schema.ts, 공통 조각 parts.ts) · 0008 씨앗 · 이미지 칸이 사이트 그림 경로도 기본값으로(patent2·3 거부) | 합침 · api typecheck·build · node --test 32/32 · web tsc·build · src 0 · copy 660곳 0. E7 측정(자기 빌드): verify 238/0/1 · 부모 :3410 과 HTML 차이 15장 0줄 · api 꺼도 0줄 | 코드에 남긴 것: 데모·쇼케이스 위젯·흐름도(실제 화면 기록) · 페이지 이력 되돌리기(R1) · 웹 타입 손 맞춤(C1) |
