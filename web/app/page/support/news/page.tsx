...
/**
 * 뉴스. 보도자료 장(press)과 같은 틀이다 — 목록·상세·검색 스크립트를 그대로 쓰고 게시판
 * 키만 news 다. 옛 PHP 짝이 없는 새 장이다.
 *
...
const PATH = '/page/support/news'

export const metadata = pageMeta({
  title: '뉴스',
  description:
    '디알밸류의 새 소식과 활동을 전합니다.',
  path: PATH,
})
...
window.BOARD = { key: "news", api: '/api/content/posts', pageSize: 10, title: "\\ub274\\uc2a4" };
...
function dvRenderList(payload, cur, hasSearch){
    ...
    if(!items.length){
        var box = hasSearch
            ...
            : dvStateBox('doc', '아직 등록된 뉴스가 없습니다', '새 소식이 올라오면 이곳에 바로 보입니다.',
