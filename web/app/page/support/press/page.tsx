...
const PATH = '/page/support/press'

export const metadata = pageMeta({
  title: '보도자료',
  description:
    '디알밸류가 언론에 소개된 소식과 보도자료를 모았습니다.',
  path: PATH,
})
  ...
  return (
    <>
      ...
      <SolutionShell
        ...
        desc="디알밸류가 언론에 소개된 소식과 보도자료를 모았습니다."
...
window.BOARD = { key: "press", api: '/api/content/posts', pageSize: 10, title: "\\ubcf4\\ub3c4\\uc790\\ub8cc" };
...
function dvRenderList(payload, cur, hasSearch){
    ...
    if(!items.length){
        var box = hasSearch
            ...
            : dvStateBox('doc', '아직 등록된 보도자료가 없습니다', '새 소식이 올라오면 이곳에 바로 보입니다.',
